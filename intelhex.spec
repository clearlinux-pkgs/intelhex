...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697563958
...
cp %{_builddir}/intelhex-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/intelhex/afe5cf57dace507920199f9f31f266dd66cd9765 || :
